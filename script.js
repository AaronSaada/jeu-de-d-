...
lancerLesDes.addEventListener('click', function() {
  ...
  if (partieEnCours) {
    ...
    des.src = 'image'+ nombreAleatoire +'.png';
...
garderLeScore.addEventListener('click', function(){
    ...
    if (partieEnCours){
        ...
        if(scores[joueurActif] >= 100){
            ...
            document.getElementById('player' + joueurActif + '-interface').classList.remove('current-player');
...
function init() {
    ...
    document.getElementById('round-score-int-2').textContent = '0';
    ...
    document.getElementById('player2-interface').classList.remove('current-player');
    document.getElementById('player1-interface').classList.remove('inactive-player');
    document.getElementById('player2-interface').classList.remove('inactive-player');
    // On ajoute la classe 'current-player' au joueur 1.
    document.getElementById('player1-interface').classList.add('current-player');
    document.getElementById('player2-interface').classList.add('inactive-player');
}